...
<html>
    <head>
        ...
        <?php _css(':colorpicker_css', ':colorpicker_css'); ?>
        <?php _css('
          :bootstrap_css,
          :notify_css,
    ...
    <body>
        ...
        <?php _js(':bootstrap_js, :jquery_ui_js, :notify_js, :jquery_form, :colorpicker_js, @system/js/layout.js, @system/js/customizer.js, :handlebars'); ?>
        <?= _block('js'); ?>
