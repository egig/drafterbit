...
'assets' => [
        ...
        'datetimepicker_js'             => '%path.vendor.asset%/smalot-bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js',
        'datetimepicker_css'            => '%path.vendor.asset%/smalot-bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css',
        'sticky_kit'                => '%path.vendor.asset%/sticky-kit/jquery.sticky-kit.min.js'
]
