...
{
    function startAction(Request $request)
    {
    ...
    function stepAction($index, Request $request){
    ...
    function finalAction(Request $request)
    {
        if($request->getMethod() == "POST") {
    ...
    function doneAction(Request $request)
    {
    ...
    function doctrineAction(Request $request){
