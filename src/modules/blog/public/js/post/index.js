        ...
        handleIndexTable: function (selector, checkSelector) {
            ...
            drafTerbit.blog.dt =  $(selector).dataTable({
                ...
                columns: [
                    ...
                    {data: 'title', render: function(d,t,f,m){ return '<a href="'+drafTerbit.adminUrl+'blog/post/edit/'+f.id+'">'+d+'</a>'}},
                    {data: 'author_id', render: function(d,t,f,m){ return '<a href="'+drafTerbit.adminUrl+'user/edit/'+f.user_id+'">'+d+'</a>'}},
                    {data: 'updated_at'},
                ],
                ajax: {
                    data: function(data) {
