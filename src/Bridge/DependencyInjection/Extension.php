...
abstract class Extension extends BaseExtension {
    ...
    {
        if($container->hasParameter(SystemBundle::NAVIGATION)) {
            $currentConfig = $container->getParameter(SystemBundle::NAVIGATION);
        } else {
            $currentConfig = [];
        }

        $container->setParameter(SystemBundle::NAVIGATION, array_merge($currentConfig, $config));
    }
