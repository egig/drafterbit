...
(function ($, drafTerbit) {
    ...
    var refreshPreview = function refreshPreview() {
    ...
    drafTerbit.MENU = {
        set: function set(position, id, label) {
    ...
    drafTerbit.customizer = {
        ...
        handleMainForm: function handleMainForm() {
        ...
        listenWindowClose: function listenWindowClose() {
        ...
        handlePreviewFrame: function handlePreviewFrame() {
        ...
        makeWidgetSortable: function makeWidgetSortable() {
        ...
        handleThemeOptions: function handleThemeOptions() {
        ...
        deleteSessionOnClose: function deleteSessionOnClose() {
        ...
        widgetShowAvailable: function widgetShowAvailable() {
        ...
        widgetHandleAddition: function widgetHandleAddition() {
            // widget addition
        ...
        widgetHandleEdit: function widgetHandleEdit() {
            // widget edit form
            $(document).on('submit', '.widget-edit-form', function (e) {
                ...
                $(this).ajaxSubmit({
                    ...
                    success: function success(res, a, b, form) {
        ...
        widgetHandleDelete: function widgetHandleDelete() {
            //delete widget
        ...
        navHandleSelect: function navHandleSelect() {
