...
(function ($) {
    ...
    // add menu
    $(document).on('click', '.menu-item-adder', function (e) {
        e.preventDefault();
    ...
    $(document).on('click', '.menu-item-saver', function (e) {
        e.preventDefault();
        var menus = $(this).parent().siblings('.menu-items').children('.menu-sortable').find('li').toArray();
    ...
    $(document).on('click', '.menu-item-selector', function (e) {
